...
export function AdminReportAltri() {
  ...
  return (
    <div>
      <Typography variant="h4" gutterBottom="true" color='textPrimary'>Report per data</Typography> 
      <Box className={classes.root}>
        <AdminReportDay trigRD={checkD} />
      </Box>
      <Typography variant="h4" gutterBottom="true" color='textPrimary'>Report per singolo ordine</Typography> 
      <Box className={classes.root}>
